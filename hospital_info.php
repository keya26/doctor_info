<?php $active="hospitals"; include("header.php"); ?>
                    ...
                    <div class="blog-item">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 blog-content">
                                ...
                                <h5>Address : 40/1 , Tipu Sultan Road , dhakah 1212</h5> 
                                <h5>Ownership : Government</h5>
                                <h5>Start of activities : 1 May 1858</h5>
                                <h5>Number of beds : 100</h5>
                                <h5>Number of doctor : 40</h5>
                                <h5>Phone No : 8144048</h5>
                                </div>
                    ...
                    <div class="blog-item">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 blog-content">
                                ...
                                <h5>Address : Sher - e - Bengali Nagar , dhakah 1207</h5> 
                                <h5>Ownership : Government</h5>
                                <h5>Number of beds : 100</h5>
                                <h5>Number of doctor : 30</h5>
                                <h5>Phone No : 8144048</h5>
                                </div>
                            <div class="col-xs-12 col-sm-2 blog-content">
                                <h2><a href="#">Share</a></h2>
